...
public class OrderDTO {
    ...
    @ValidateEntity(required=true,requiredMaxLength=true,requiredMinLength=true,maxLength=64,minLength=1,errorRequiredMsg="收货人电子邮箱不能为空！",errorMaxLengthMsg="收货人电子邮箱长度不能大于64！",errorMinLengthMsg="收货人电子邮箱不能为空！")
